...
const Flooring = () => {
    return (
        <div className='pt-[40px] md:pt-[42px] lg:pt-[45px] xl:pt-[48px] 2xl:pt-[52px] 3xl:pt-[56px] 4xl:pt-[60px] 5xl:pt-[64px]'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-[50px] md:gap-[60px] lg:gap-[70px] xl:gap-[80px] 2xl:gap-[90px] 3xl:gap-[100px] 4xl:gap-[110px] 5xl:gap-[120px] py-[10px] 5xl:py-[16px] pl-[10px] 5xl:pl-[16px] pr-[69px] lg:pr-[74px] xl:pr-[79px] 2xl:pr-[84px] 3xl:pr-[89px] 4xl:pr-[94px] 5xl:pr-[99px]'>
