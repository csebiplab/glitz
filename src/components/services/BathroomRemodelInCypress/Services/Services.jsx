...
const servicesData = [
    ...
    },
    {
        ...
        desc : "Revive your bathroom sink with repair services from Glitz Floors & More. Our skilled team specializes in fixing leaks, cracks, and other damage to ensure your sink functions perfectly and looks great. Whether it's a minor repair or a more significant restoration, we use high-quality materials and techniques to deliver durable results. Trust us to restore your bathroom sink efficiently, enhancing the functionality and aesthetics of your space. Enjoy a reliable and stylish sink that meets your needs for years to come. At Glitz Floors & More, we understand the importance of a fully functioning sink in your bathroom, and our commitment to quality ensures that every repair is handled with precision and care. Our team is equipped to address various issues, from stubborn leaks to cosmetic damage, restoring your sink to its original condition. With a focus on customer satisfaction, we work quickly to minimize disruption to your daily routine while delivering ",
    }
]
    ...
    <div>
      <div className="container padding__top">
        <div className="flex flex-col items-center justify-center">
          <HeadingIcon
            text={headingIconText.services__headingIconText}
          />
