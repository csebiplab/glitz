    ...
    <div>
      <div className="container padding__top">
        ...
        <div className="">
          ...
          <p className='text-base 5xl:text-lg text-black font-normal text-center leading-[26px] lg:leading-[26px] xl:leading-[28px] 2xl:leading-[30px] 3xl:leading-[32px] 4xl:leading-[34px] 5xl:leading-[36px]'>Vinyl flooring has evolved to offer a variety of styles and formats to fit different needs, aesthetics, and budgets. Here's an overview of the main types of vinyl flooring to help you choose the right option for your space:
          </p>
        </div>
        {/* cart data  */}
