        ...
        <div className="full__section_r_p pl-3 md:pl-0 padding__top">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[16px] 5xl:gap-[20px]">
                <div className='md:col-span-1'>
                    <Image src="/assets/glitz/vinylFlooringInCypress/blendsStyle.png" alt='blend style' width={836} height={752} className='w-full h-[620px] 5xl:h-[650px]'/>
                </div>
                <div className='md:col-span-1'>
