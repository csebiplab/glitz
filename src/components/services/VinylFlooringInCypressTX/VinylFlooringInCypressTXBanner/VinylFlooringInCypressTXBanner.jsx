    ...
    <>
      <div className="relative w-screen h-[375px] md:h-[460px] lg:h-[475px] xl:h-[490px] 2xl:h-[505px] 3xl:h-[520px] 4xl:h-[535px] 5xl:h-[549px] overflow-hidden">
        <div className="hidden md:block">
          <Image
            src="/assets/glitz/vinylFlooringInCypress/lg_hero.png"
        ...
        <div className="block md:hidden">
          <Image
            src="/assets/glitz/vinylFlooringInCypress/sm_hero.png"
        ...
        <div className="container absolute inset-0 flex flex-col items-start justify-center">
          ...
          Experience top-notch vinyl flooring in Cypress, TX, with Glitz <br className="hidden md:block"/> Floors & More—your destination for elegance and durability!
          </p>
