        ...
        <div className="md:flex items-center relative">
          <div className="w-full md:w-[50%] pl-3 md:pl-5 lg:pl-10 xl:pl-20 2xl:pl-28 3xl:pl-40 4xl:pl-52 5xl:pl-[285px]">
            <div className="py-14 md:py-0 px-4 md:pl-0">
              ...
              Transform your home with a stunning <strong>kitchen remodel</strong> in <br className="hidden md:block"/> Cypress by Glitz Floors & More, where elegance meets <br className="hidden md:block"/> functionality.
              </p>
