      ...
      <div className="container padding__top">
        <div className="flex flex-col items-center justify-center">
          <NewHeadingCenterIcon
            text={headingIconText.comprehensive__headingIconText}
          />
          ...
          <p className="text-base 5xl:text-lg text-secondary-50 font-normal text-center leading-[26px] lg:leading-[26px] xl:leading-[28px] 2xl:leading-[30px] 3xl:leading-[32px] 4xl:leading-[34px] 5xl:leading-[36px]">
            At Glitz Floors & More, we offer a wide array of comprehensive
            kitchen remodeling services to meet all your needs. Our services
            include: With our extensive range of services, Glitz Floors & More
            is dedicated to making your kitchen remodel a seamless and rewarding
            experience. Let us help you create a beautiful, functional space
        ...
        {/* second div  */}
        <div className="w-full flex flex-col md:flex-row items-center justify-center gap-[60px] 5xl:gap-[75px] mt-[25px]">
          <div className="w-full md:w-1/3 relative">
            <Image
              src="/assets/glitz/kitchenRemodel/services/services13.png"
              alt="working image"
              width={129}
              height={129}
              className="w-[129px] h-[129px] mx-auto"
            ...
            <p className=" text-base 5xl:text-lg font-light text-black text-center pb-[25px]">
              Sustainable materials and energy-efficient appliances for those
          ...
          <div className="w-full md:w-1/3 relative">
            <Image
              src="/assets/glitz/kitchenRemodel/services/services14.png"
              alt="working image"
              width={129}
              height={129}
              className="w-[129px] h-[129px] mx-auto"
            ...
            <p className=" text-base 5xl:text-lg font-light text-black text-center pb-[25px]">
              Custom solutions to ensure your kitchen is accessible and
              functional for everyone, regardless of mobility challenges.
            </p>
            <div className="absolute bottom-0 w-full h-[2px] bg-secondary-300" />
          </div>
        </div>
