          ...
          <div className="grid grid-cols-8 gap-10 5xl:gap-[54px]">
            ...
            <div className="col-span-2">
              ...
              <ul className="text-white font-family-primary">
                ...
                <li className="text-base 5xl:text-lg font-normal text-white leading-[27px] py-[10px] 5xl:py-[14px]">
                  10:00 am - 06:00 p.m.
                </li>
                <li className="text-base 5xl:text-lg font-normal text-white leading-[27px]">
                  Friday{" "}
            ...
            <div className="col-span-2">
              ...
              <div className="flex items-center gap-[30px] pt-[29px]">
                ...
                <FaXTwitter className="w-[21px] h-[21px]"/>
      ...
      <div className="block md:hidden">
        <div className="small_footer_image ">
          ...
          <div className="pt-[20px] px-[30px]">
            <p className="font-family-primary flex items-center justify-center gap-[10px] 5xl:gap-[16px] text-lg text-center font-bold text-white pb-[17px] leading-[29px]">
            <CiClock2 className="w-[24px] h-[24px]"/>
              Hours of Operations:
            </p>
            <ul className="text-white font-family-primary">
              ...
              <li className="text-base md:text-lg text-center font-normal text-white leading-[27px] py-[10px]">
                10:00 am - 06:00 p.m.
              </li>
