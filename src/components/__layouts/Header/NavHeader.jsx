              ...
              <div>
                <div className="full__section_r_p pb-[6px] 5xl:pb-[8px] flex justify-end gap-[12px] 2xl:gap-[14px] 5xl:gap-[16px]">
                  ...
                  <div className="flex  gap-[30px]">
                    ...
                    <a rel="nofollow" target="_blank" href="https://www.facebook.com/profile.php?id=61559301724341"><FaFacebook className="h-[22px] w-[22px] text-secondary"/></a>

                    <a rel="nofollow" target="_blank" href="https://www.tiktok.com/@lavishluxnailsspa"><AiFillTikTok className="h-[22px] w-[22px] text-secondary"/></a>

                    <a rel="nofollow" target="_blank" href="https://www.instagram.com/lavishluxnailspa_sauga/"><FaInstagram className="h-[22px] w-[22px] text-secondary"/></a>
