  ...
  return (
    <div data-aos="zoom-in" className="custom-container padding__top">
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <p className="text-[25px] md:text-[27px] lg:text-[30px] xl:text-[33px] 2xl:text-[35px] 3xl:text-[38px] 4xl:text-[40px] 5xl:tex-[42px] text-black font-bold leading-light">
          Floor Now, Pay Over Time
        </p>
        <div className="flex justify-center items-center">
          <svg
