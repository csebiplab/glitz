        ...
        <div data-aos="fade-right" className="relative">
          ...
          {showBathroomOverlay && (
            <div className="h-2/3 absolute top-[33%] inset-0 bg-black/90 text-white p-4 flex flex-col justify-center">
              ...
              <p className="text-[15px] 5xl:text-lg font-normal text-center leading-normal text-white">
              Your bathroom should be more than just functional—it should be a relaxing sanctuary that combines style and comfort. At Glitz Floors & More, we specialize in transforming outdated bathrooms into modern,
              </p>
              <button className="mt-1 flex justify-center items-center gap-2 text-white text-sm font-bold leading-[20px] underline pb-2">Bathroom Remodeling <FaArrowRightLong className="mt-1"/></button>
            </div>
          )}
        </div>
          ...
          <div data-aos="fade-left" className="relative">
            ...
            {showKitchenOverlay && (
              <div className="h-2/3 absolute top-[33%] inset-0 bg-black/90 text-white p-4 flex flex-col justify-center">
                ...
                <button className="mt-1 flex justify-center items-center gap-2 text-white text-sm font-bold leading-[20px] underline pb-2">Kitchen Remodeling <FaArrowRightLong className="mt-1"/></button>
              </div>
            )}
          </div>
        </div>
