              ...
              <div className="w-[302px] mx-auto flex items-center justify-between robot__bg pt-[11px] pb-[7px] pl-[13px] pr-[12px]">
                ...
                <div>
                  <Image
                    ...
                    src="/assets/glitz/icons/captcha.png"
                    alt="captcha"
                    width={32}
                    height={32}
                  />
                  <p className="text-center text-[10px] font-normal text-dark-200 pt-[5px] pb-[2px]">
                    reCAPTCHA
                  </p>
                  <p className="text-center text-[8px] font-normal text-dark-200">
                    Privacy <span> - </span> <span>Terms</span>
                  </p>
                </div>
              </div>
