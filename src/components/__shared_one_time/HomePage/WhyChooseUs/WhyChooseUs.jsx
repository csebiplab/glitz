        ...
        <div className="shadow-sm md:mx-0 xs:mx-[35px] ">
          <div className=" grid md:grid-cols-3 2xl:gap-[40px] md:gap-[30px] ">
            ...
            <div className="w-full border-2 my-6 md:my-0 cart1">
              <p className="title-bg text-center 2xl:py-[15px] py-[14px] text-primary text-base md:text-lg font-bold">
            ...
            <div className="border-2 my-6 md:my-0 cart2">
              ...
              <Image src="/assets/glitz/icons/contact_brand_logo.png" alt="bland logo" width={80} height={40}/>
            ...
            <div className="mx-auto flex flex-col items-center justify-center">
              ...
              <div>
                <h2 className="text-[25px] md:text-[26px] lg:text-[29px] xl:text-[32px] 2xl:text-[35px] 3xl:text-[38px] 4xl:text-[41px] 5xl:text-[44px] font-bold text-secondary leading-normal py-[5px] text-center xl:text-left">
                Why Choose Our Floor Refinishing Service
                </h2>
              </div>

              <div>
                <p className="text-lg font-normal md:text-start text-center text-secondary-50">
