    ...
    <div className="">
      <div className=" container padding__top">
        ...
        <div className="hidden xl:block 5xl:hidden floorsNow__bg_md">
          <div className="h-full flex flex-col justify-center items-center">
          <h2 className=" text-3xl md:text-[32px] lg:text-[34px] xl:text-[36px]  2xl:text-[38px] 3xl:text-[40px] 4xl:text-[42px] 5xl:text-[44px] font-bold text-white">
            FLOORS NOW, PAY OVER TIME
          </h2>
          <p className=" text-lg font-normal text-[25px] text-white pt-[5px]">
            Convenient monthly{" "}
        ...
        <div className="block md:hidden floorsNow__bg_sm h-full flex flex-col justify-center items-center ">
          <h2 className=" text-3xl font-bold text-white text-center">
            FLOORS NOW, PAY <br className="block md:hidden"/> OVER TIME
          </h2>
          <p className=" text-lg font-normal text-[25px] text-white pt-[5px] text-center">
