    ...
    <div className="">
      <div className=" container padding__top">
        ...
        <div className="hidden 5xl:block floorsNow__bg">
          ...
          <h2 className="font-family-secondary text-3xl md:text-[32px] lg:text-[34px] xl:text-[36px]  2xl:text-[38px] 3xl:text-[40px] 4xl:text-[42px] 5xl:text-[44px]  5xl:text-[44px] font-bold text-white">
          ...
          <div className="pt-[30px] 5xl:pt-[35px]">
              <button className="font-family-secondary text-lg font-normal text-white btn__bg_floor_now pl-[37px] pr-[36px] pt-[17px] pb-[14px] ">View Financing Option</button>
          </div>
          </div>
        </div>
        {/* medium device  */}
        <div className="hidden xl:block 5xl:hidden floorsNow__bg_md">
          ...
          <div className="font-family-secondary pt-[30px] 5xl:pt-[35px]">
        ...
        <div className="block md:hidden floorsNow__bg_sm h-full flex flex-col justify-center items-center ">
          <h2 className="font-family-secondary text-3xl font-bold text-white text-center">
            FLOORS NOW, PAY OVER TIME
          </h2>
