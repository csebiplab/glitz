      ...
      <div className="container padding__top">
        <div className="bg__color grid grid-cols-1 xl:grid-cols-2 gap-[35px]">
          <div className="order-2 xl:col-span-1 py-[46px]">
            <div>
              <h2 className="font-family-primary text-[25px] md:text-[26px] lg:text-[29px] xl:text-[32px] 2xl:text-[35px] 3xl:text-[38px] 4xl:text-[41px]  5xl:text-[44px] font-bold text-secondary leading-normal pb-[5px] text-center xl:text-left">
              ...
              <button className="font-family-primary text-lg font-normal text-[#905C4C] btn_bg px-[46px] py-[15px]">See How It Works</button>
              </div>
