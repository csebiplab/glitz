...
const FlooringInstallationBanner = () => {
  return (
    <>
      <div className="relative w-screen h-[459px] md:h-[460px] lg:h-[475px] xl:h-[490px] 2xl:h-[505px] 3xl:h-[520px] 4xl:h-[535px] 5xl:h-[549px] overflow-hidden">
        <div className="hidden md:block">
          <Image
            src="/assets/glitz/flooring-installation/lg_hero.png"
        ...
        <div className="block md:hidden">
          <Image
            src="/assets/glitz/flooring-installation/sm_hero.png"
        ...
        <div className="container absolute inset-0 flex flex-col items-start justify-center">
          ...
          Remodeling & Flooring <br className="block md:hidden"/> Installation <br/> in Cypress, TX
          </h1>
          <p className="text-lg font-normal text-white leading-[35px] px-[10px] md:px-0">
          Glitz Floors & More provides professional remodeling and flooring installation in <br className="hidden md:block"/> Cypress, TX, delivering exceptional results for every project.
          </p>
...
export default FlooringInstallationBanner;
