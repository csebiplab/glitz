      ...
      <div className="container pt-[10px]">
            ...
            >
              <div className="w-full !flex items-center gap-5 5xl:gap-16">
                <div className="pl-5 5xl:pl-14">
                  <p className="text-xs 5xl:text-sm text-secondary font-bold leading-normal pb-[7px]">
        ...
        <div className="block md:hidden">
          <div className="brand__bg py-[19px] border-2 border-red-500" >
            <div className="">
              <p className="text-base text-secondary text-center font-bold leading-normal pb-[7px]">
                Verifying Review From Trusted Site:{" "}
              </p>
              <Image
                src="/assets/glitz/icons/five_star.png"
