            ...
            <div className='full__section_r_p pl-3 md:pl-0 padding__top'>
                <div className='grid grid-cols-1 xl:grid-cols-2 gap-[35px]'>
                    ...
                    <div className='xl:col-span-1'>
                        ...
                        <div>
                            <h2 className='font-family-secondary text-[25px] md:text-[26px] lg:text-[29px] xl:text-[32px] 2xl:text-[35px] 3xl:text-[38px] 4xl:text-[41px]  5xl:text-[44px] font-bold text-secondary leading-normal pt-[10px] pb-[5px] text-center xl:text-left'>About Our Cypress Flooring Store</h2>
